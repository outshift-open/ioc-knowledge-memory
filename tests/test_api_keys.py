...
class TestApiKeyEndpoints:
    ...
    def test_api_key_isolation_between_workspaces(self, client, sample_workspace_data):
        ...
        workspace1_response = client.post("/api/workspaces", json={
            **sample_workspace_data, "name": "Workspace 1"
        })
        workspace1_id = workspace1_response.json()["id"]
        
        workspace2_response = client.post("/api/workspaces", json={
            **sample_workspace_data, "name": "Workspace 2"  
        })
