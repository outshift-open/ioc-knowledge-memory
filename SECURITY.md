...
`ioc-knowledge-memory-svc` project.
...
The `ioc-knowledge-memory-svc` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ioc-knowledge-memory-svc`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ioc-knowledge-memory-svc` leverages GitHub's private vulnerability reporting.
